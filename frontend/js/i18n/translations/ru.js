...
export default {
  ...
  kite: {
    ...
    tooLight: 'Слишком слабый ветер',
    tooStrong: 'Слишком сильный ветер',
    none: 'Не рекомендуется',
    kg: 'кг',
    // Рекомендации по ветру
    veryWeak: '🏖️ Слишком слабый ветер для кайтсёрфинга',
    weak: '💨 Слабый ветер - нужен большой кайт (17м)',
    goodConditions: '✨ Хорошие условия - средний кайт (12-14м)',
    excellentConditions: '🔥 Отличные условия - маленький кайт (9-12м)',
    strongWind: '💪 Сильный ветер - малый кайт (9м)',
