...
export default {
  ...
  app: {
    ...
    error: 'Ошибка',
    retry: 'Повторить',
    footer: '© 2026. Создано с ❤️ для кайтсерферов',
  },
  ...
  forecast: {
    ...
    usingModel: 'Модель',
    longTitle: 'Прогноз ветра на 10 дней',
  },
  ...
  history: {
    ...
    accuracy: {
      title: '🎯 Точность моделей прогноза',
      noData: 'Бэктест ещё не запускался',
      run: 'Запустить бэктест (2 года)',
      refresh: 'Обновить бэктест',
      running: 'Запущено… (5–15 мин)',
      evalShort: 'оц.',
      bias: 'Bias',
      dir: 'напр.',
      hint: 'RMSE/MAE — средняя ошибка модели по скорости; Bias > 0 — модель завышает; напр. — средняя ошибка направления.',
    },
  },
